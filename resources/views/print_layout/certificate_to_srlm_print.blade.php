...
<div class="row">
    <div class="col-12 text-center">
        <h4 class="m-0">SF 6.1A: Letter to SRLM seeking information on mobilization plan</h4>
        <span>(To be printed on PIA Letterhead)</span>
    </div>
    <div class="col-11 mt-5 mx-auto">
        <p>
            ...
            Organization <br>
            Address <br><br>
            <span style="font-weight: bold">Subject:</span> Seeking information on mobilization plan for (Name of Project)<br>
