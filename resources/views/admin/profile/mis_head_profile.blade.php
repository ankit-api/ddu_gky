                        ...
                        <form action="{{ route('post_update_profile') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row ">            
                                <div class="col-md-4 mx-auto">    
                                    ...
                                    <input type="text" name="name" required class="form-control" value="{{ $mis_data->name }}" placeholder="Enter Name" >
                                </div>                                      
                                <div class="col-md-4 mx-auto">    
                                    <label class="m-2">Email</label>
                                    <input type="email" name="email" required class="form-control" value="{{ $mis_data->email }}" placeholder="Enter Email" >
                                </div>                                                  
                                <div class="col-md-4 mx-auto">    
                                    <label class="m-2">Contact</label>
                                    <input type="text" name="contact" required class="form-control" value="{{ $mis_data->phone_no }}" placeholder="Enter Contact" >
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-12 mx-auto">
                                    <label class="m-2">Address</label>
                                    <textarea name="address" required placeholder="Enter Address" rows="3" style="width:100%; border-radius: 4px; border:1px solid #dee2e6;padding-left: 15px; font-size: 15px;">{{ $mis_data->address }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <a href="{{ asset('Documents/MIS/'.$mis_data->photo)}}" target="_blank"class="text-light btn btn-primary">View Photo</a>
                                            </div>
                                        </div>                                    
                                    </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="" class="m-2">Attach Signature  <span style="font-size: 14px;font-weight: 600;color: #ee1201;">(Image size should be less than 512Kb)</span></label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8">
